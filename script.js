...
const getNavPage = (href) => {
  const cleanHref = href.split("#")[0].split("?")[0];
  const page = cleanHref.split("/").pop();
  return page || "index.html";
};

const getNavHash = (href) => {
...
document.querySelectorAll(".nav-links a").forEach((link) => {
  ...
  const linkPage = getNavPage(href);
  const linkHash = getNavHash(href);
  const isHashMatch = linkHash && linkPage === currentPage && linkHash === location.hash;
  const isPageMatch = linkPage === currentPage && !linkHash && (!location.hash || currentPage !== "index.html");
...
document.querySelectorAll("table").forEach((table) => {
  ...
  table.querySelectorAll("tbody tr").forEach((row) => {
    Array.from(row.children).forEach((cell, index) => {
      if (cell.tagName.toLowerCase() === "td" && headers[index] && !cell.dataset.label) {
...
const translations = {
  en: {
    ...
    "加入学习社群": "Join Learning Community",
    ...
    "活动入口": "Access",
    "了解公开课或加入学习社群": "Explore an open class or join the learning community",
...
const SEO_IMAGE_ALT = "Grand Markets Academy brand mark";

const seoProfiles = {
  "index.html": {
    zh: {
      title: "Grand Markets Academy | 精品金融教育学院",
      description: "Grand Markets Academy 是专业金融教育学院，帮助学习者选择金融市场基础、RG146、量化系统、交易员训练和市场知识学习方向。",
      keywords: "Grand Markets Academy, 精品金融教育学院, 金融市场学习, RG146, 量化学习, 交易员培训",
      label: "首页",
    },
    en: {
      title: "Grand Markets Academy | Boutique Finance Education Academy",
      description: "Grand Markets Academy helps learners choose finance education directions across market foundations, RG146, quant systems, trader training and market knowledge.",
      keywords: "Grand Markets Academy, boutique finance education academy, financial market learning, RG146, quant learning, trader training",
      label: "Home",
    },
  },
  "learning-path.html": {
    zh: {
      title: "学习路径 | Grand Markets Academy",
      description: "Grand Markets Academy 七步学习路径，帮助学习者从金融市场基础、外汇、CFD、风险管理、交易心理到案例演练和学习社群建立顺序。",
      keywords: "Grand Markets Academy 学习路径, 金融市场基础, 外汇学习, CFD 风险, 风险管理, 交易心理",
      label: "学习路径",
    },
    en: {
      title: "Learning Path | Grand Markets Academy",
      description: "A seven-step learning path from market foundations, forex, CFDs, risk management and trading psychology to guided practice and community learning.",
      keywords: "Grand Markets Academy learning path, financial market basics, forex learning, CFD risk, risk management, trading psychology",
      label: "Learning Path",
    },
  },
  "courses.html": {
    zh: {
      title: "课程框架 | Grand Markets Academy",
      description: "查看 Grand Markets Academy 课程框架，比较金融市场基础、RG146、量化中心、交易员培训、市场知识库与合规风险边界模块。",
      keywords: "Grand Markets Academy 课程, RG146 课程, 量化中心, 交易员培训, 金融市场知识, 合规风险管理",
      label: "课程框架",
    },
    en: {
      title: "Course Framework | Grand Markets Academy",
      description: "Compare Grand Markets Academy modules across market foundations, RG146, Quant Academy, Trader Training, market knowledge and compliance boundaries.",
      keywords: "Grand Markets Academy courses, RG146 course, Quant Academy, Trader Training, market knowledge, compliance risk management",
  ...
  "community.html": {
    zh: {
      title: "Grand Markets 学习社群 | Grand Markets Academy",
      description: "Grand Markets 学习社群面向金融市场学习者，提供市场教育讨论、线上分享、Academy 课程更新和合规边界提醒。",
      keywords: "Grand Markets Academy, Grand Markets 学习社群, 交易学习者, 市场学习交流, 学习社群, 金融教育社群",
      label: "学习社群",
    },
    en: {
      title: "Grand Markets Learning Community | Grand Markets Academy",
      description: "The Grand Markets Learning Community helps learners discuss market education, join sessions, receive Academy updates and review risk boundaries.",
      keywords: "Grand Markets Academy, Grand Markets Learning Community, market education discussions, weekly educational sessions, Learning community, finance education community",
...
const seoClusterProfiles = {
  "index.html": [
    ["学习路径", "Learning path", "learning-path.html"],
    ["课程框架", "Course framework", "courses.html"],
    ["合规边界", "Compliance boundary", "compliance.html"],
    ["学习社群", "Learning community", "community.html"],
  ],
  "learning-path.html": [
    ["金融市场基础", "Financial market basics", "knowledge.html"],
    ["CFD 产品与杠杆", "CFD products and leverage", "topic.html?article=cfd-basics"],
    ["风险管理", "Risk management", "compliance.html"],
    ["课程框架", "Course framework", "courses.html"],
  ],
  "courses.html": [
    ["RG146 学习中心", "RG146 Learning Centre", "rg146.html"],
    ["量化中心", "Quant Academy", "quant.html"],
    ["交易员培训", "Trader Training", "traders.html"],
    ["市场知识库", "Market Knowledge Library", "knowledge.html"],
  ],
  "rg146.html": [
  ...
  "community.html": [
    ["金融市场基础", "Financial market basics", "knowledge.html"],
    ["教育活动", "Educational events", "events.html"],
    ["风险与合规", "Risk and compliance", "compliance.html"],
    ["返回首页", "Back to homepage", "index.html"],
  ],
  "topic.html": [
...
const buildStructuredData = (lang, profile) => {
  ...
  const navigationPages = ["index.html", "learning-path.html", "courses.html", "rg146.html", "quant.html", "traders.html", "knowledge.html", "community.html", "about.html"];
  const navigationItems = navigationPages.map((page, index) => {
    const itemProfile = seoProfiles[page]?.[lang] || seoProfiles["index.html"][lang];
    const url = page === "index.html" ? homeUrl : `${SEO_BASE_URL}/${page}?lang=${lang}`;
    return {
      "@type": "SiteNavigationElement",
      position: index + 1,
      name: itemProfile.label,
      url,
    };
  });
  const graph = [
    ...
    {
      "@type": "ImageObject",
      "@id": `${SEO_LOGO_URL}#logo`,
      url: SEO_LOGO_URL,
      caption: SEO_IMAGE_ALT,
      inLanguage,
    },
    {
      "@type": "WebSite",
  ...
  if (profile.course) {
    graph.push({
      ...
      audience: {
        ...
        educationalRole: lang === "zh" ? "金融市场学习者" : "Financial markets learner",
      },
      inLanguage,
...
const applySeo = (lang) => {
  ...
  setMetaName("application-name", "Grand Markets Academy");
  setMetaName("apple-mobile-web-app-title", "Grand Markets Academy");
  ...
  setMetaProperty("og:image:alt", SEO_IMAGE_ALT);
  setMetaProperty("og:locale", lang === "zh" ? "zh_CN" : "en_AU");
  setMetaProperty("og:locale:alternate", lang === "zh" ? "en_AU" : "zh_CN");
  ...
  setMetaName("twitter:image:alt", SEO_IMAGE_ALT);
...
const showSubmissionGuidance = (form) => {
  ...
  guidance.innerHTML = `
    ...
    <div class="submission-actions">
      ...
      <a class="button secondary" href="/community.html"><span data-lang-panel="zh">再加入学习社群</span><span data-lang-panel="en">Then Join Community</span></a>
    </div>
  `;
  applyLanguage(lang);
